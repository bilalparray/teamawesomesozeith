...
const BilalScoreArray = [53, 5, 0, 14, 0, 10, 0, 7, 2, 14, 28, 0, 1, 15, 11];

const BilalLastFourArray = [1, 15, 11];

// ///////////////////////////////////

const OwaisScoreArray = [14, 42, 14, 0, 19, 10, 19, 0, 6, 1, 49, 4, 11, 0, 41];
...
const SahilScoreArray = [
  4, 10, 60, 26, 42, 6, 42, 0, 18, 25, 5, 18, 18, 59, 82,
];
...
const EhsaanScoreArray = [0, 0, 0, 0, 0, 10, 0, 0, 14, 0, 7, 0, 25, 14];
...
const ZahidScoreArray = [
  43, 59, 26, 19, 22, 11, 22, 49, 6, 11, 4, 23, 0, 1, 32,
];
...
const SuhailScoreArray = [25, 13, 12, 35, 0, 43, 0, 0, 28, 52, 2, 9, 18, 0, 14];
...
const IshtiyaqScoreArray = [
  2, 10, 0, 34, 52, 46, 52, 0, 4, 11, 0, 14, 11, 0, 4,
];
...
const MuzamilScoreArray = [
  0, 40, 28, 56, 18, 15, 13, 0, 36, 20, 32, 12, 34, 10, 4,
];
...
const UbiScoreArray = [17, 10, 35, 1, 0, 10, 0, 34, 38, 0, 1, 0, 4, 23, 1];

const UbiLastFourArray = [4, 23, 1];

// /////////////////////////////////////////

const LiyaqatScoreArray = [0, 5, 13, 3, 13, 14, 13, 0, 58, 21, 10, 8, 6, 32, 0];

const LiyaqatLastFourArray = [6, 32, 0];

// ////////////////////////////////////////

const ShowketScoreArray = [17, 6, 0, 14, 21, 14, 21, 0, 0, 8, 2, 4, 17, 14, 10];
...
const MuzamilWicketArray = [4, 1, 1, 4, 1, 2, 1, 3, 1, 4, 2];
